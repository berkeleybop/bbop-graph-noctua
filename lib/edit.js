 ...
 */
noctua_graph.prototype.create_node = function (id, label, types, inferred_types, inferred_types_with_all, iroot_types) {
	return new noctua_node(id, label, types, inferred_types, inferred_types_with_all, iroot_types);
};
...
noctua_graph.prototype.add_node_from_individual = function (indv) {
	...
	if (iid) {
		...
		var iroot_types = indv['root-type'] || [];
		new_node = anchor.create_node(iid, null, itypes,
			inf_itypes, inf_itypes_with_all, iroot_types);
...
noctua_graph.prototype.merge_in = function (in_graph) {
	...
	each(in_graph_anns, function (ann) {
		...
		// add a clone.
		if (anchor.get_annotations_by_filter(function (a) {
 ...
 * @returns {this}
 */
function noctua_node(in_id, in_label, in_types, in_inferred_types, in_inferred_types_with_all, in_root_types) {
 ...
 *
 * Parameters:
 * @returns {Array} array of root types
 */
