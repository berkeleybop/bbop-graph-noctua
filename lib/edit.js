...
/**
 * Returns a triple of the referenced individual's id, a best attempt
 * at a single string representation of its class expression, and the
 * string representation of one of its annotations by key.
 *
 * @name get_referenced_individual_profiles
 * @function
 * @param {String} annotation_key - (optional) the key for the third term's value 
 * @returns {Array} list of referenced_individuals with that ID
 */
function _get_referenced_individual_profiles(annotation_key){
    var anchor = this;
